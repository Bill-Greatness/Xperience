...
import {View, StyleSheet, Modal, Text, TextInput, Button, TouchableHighlight} from 'react-native'
            ...
            >
                <View style={styles.centeredView}>
                    ...
                    <View style={styles.inputView}>
                        ...
                        style={styles.inputs} placeholderTextColor="silver" placeholder="Title/Summary" />

                        <TextInput value={content} onChangeText={(text) => setContent(text)} 
                        style={styles.inputs} multiline placeholder="Content" placeholderTextColor="silver" 
                        maxLength={500} numberOfLines={5}/>
                        
                        <View style={{display:'flex', flexDirection:'row'}}>
                        <TouchableHighlight onPress={() => launchImageLibrary({
                            mediaType:'photo',
                            quality:1,
                        ...
                        <TouchableHighlight onPress={() => launchCamera({
                            mediaType:'photo',
                            quality:1,
                            saveToPhotos:true,
                        },(resp) => console.log(resp))} style={styles.pickButtons}>
